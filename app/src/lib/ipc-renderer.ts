...
export function invoke<T extends keyof RequestResponseChannels>(
  ...
  return ipcRenderer.invoke(channel, ...argsArray) as any
}
...
export function send<T extends keyof RequestChannels>(
  ...
  const argsArray = (args || []) as unknown as any[]
  return ipcRenderer.send(channel, ...argsArray) as any
}
...
export function sendSync<T extends keyof RequestChannels>(
  ...
  const argsArray = (args || []) as unknown as any[]
  return ipcRenderer.sendSync(channel, ...argsArray) as any
}
